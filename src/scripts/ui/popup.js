document.addEventListener("DOMContentLoaded", () => {
  ...
  const micChipLabelEl = document.getElementById("mic-chip-label");
  ...
  function renderCallStatus(callStatus) {
    ...
    if (view.chip) {
      micChipEl.classList.toggle("is-live", view.chip.icon === "mic");
      micChipEl.classList.toggle("is-muted", view.chip.icon === "mic-off");
      micChipLabelEl.textContent = view.chip.label;
